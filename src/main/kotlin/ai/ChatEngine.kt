 ...
 * 도구 호출이면 ToolRegistry로 실행 → 결과를 Outcome으로 반환.
 */
class ChatEngine(private val registry: ToolRegistry) {
    ...
    suspend fun send(key: String, model: String, targetNote: NoteItem?, history: List<ChatMsg>): Outcome =
