...
data class Ink(
    ...
    val local: Color, val localSoft: Color, val localInk: Color,
)
...
val LightInk = Ink(
    ...
    local = Color(0xFF0E9E77), localSoft = Color(0xFFE2F4EE), localInk = Color(0xFF0B6E54),
)
...
val DarkInk = Ink(
    ...
    local = Color(0xFF41C69C), localSoft = Color(0xFF12332A), localInk = Color(0xFF7FDCC0),
)
